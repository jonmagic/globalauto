...
class UserControllerTest < ActionController::TestCase
  ...
  def test_bad_signup
    ...
    post :signup, :user => { :login => "newbob", :password => "newpassword", :password_confirmation => "wrong", :firstname => "New", :lastname => "Bob"}
    assert_response :success
    # assert_invalid_column_on_record "user", "password"
    assert_template "user/signup"
    assert_nil session[:user]
  
    post :signup, :user => { :login => "yo", :password => "newpassword", :password_confirmation => "newpassword", :firstname => "New", :lastname => "Bob"}
    assert_response :success
    # assert_invalid_column_on_record "user", "login"
    assert_template "user/signup"
    assert_nil session[:user]
  
    post :signup, :user => { :login => "yo", :password => "newpassword", :password_confirmation => "wrong", :firstname => "New", :lastname => "Bob"}
    assert_response :success
